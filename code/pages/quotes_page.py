...
class QuotesPage:
    ...
    # ia dropdawnul in care se introduce autorul . Pt a selecta un element se fol metoda select_author
    # returneaza un obiect   de select care are are mai multe options. Ca sa selectezi un options folosesti
    # metoda de mai jos select_author
    @property
    ...
    # selecteaza din dropdawnul autorului un element (pe care il primeste ca argument)
    # deschide on obiect select, vede ce e acolo si selecteaza option care e egala cu author_name.
    # practic la final pune in tagul select (dat de metoda de mai sus author_dropdown)  elementul selectat (author_name)
